...
var TWITTER_SCREEN_NAME = 'rac2030';
var FRIENDFEED_USERNAME = 'rac2030';
var GPLUS_PROFILE_ID = '109163915105172405583';
var GOOGLE_API_KEY = 'AIzaSyCIWjkIrIL_c5ZoyiIh1uWRg8A_N8EcDmg';
...
function reloadStream() {
  ...
  $('#stream').empty();
  $('<div class="loading">').appendTo('socialstreamcontent');
...
function rebuildStreamUI(entries) {
  ...
  for (var i = 0; i < entries.length; i++) {
    ...
    var faviconUrl = (urlDomain.match(/plus\.google/))
        ? '/img/socialstream/plus-favicon.png'
